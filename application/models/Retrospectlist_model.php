...
/**
 * Description of Retrospectlist_model
 *
 * @author nut
 */
class Retrospectlist_model extends CI_Model {
    ...
    public function count_pagination($filter) {
        ...
        $this->db->where('work_info.work_info_retrospect', 1);
    ...
    public function ref_work_type($work_type_id = null) {
        ...
        if ($work_type_id != null) {
            ...
            $this->db->where_in('ref_work_type.work_type_id', array(1, 2, 6));
        }
    ...
    public function get_ref_state_info() {
        $this->db->where_in('ref_state_info.state_info_id', array(2,5,9));
