...
class Receivework_model extends CI_Model {

    public function count_pagination($filter) {
        $this->db->select('work_user.work_user_id');
        $this->db->from('work_user');
        $this->db->join('work_info', 'work_user.work_info_id_pri = work_info.work_info_id_pri');
        $this->db->join('work_process', 'work_process.work_process_id_pri = work_user.work_process_id_pri');
        ...
        if ($filter['work_user_status_id'] != '') {
            $this->db->where("work_user.work_user_status_id", $filter['work_user_status_id']);
        }
        ...
        $this->db->group_by('work_user.work_user_id');
        return $this->db->get()->num_rows();
    }

    public function get_pagination($filter, $params = array()) {
        $this->db->select('work_user.work_user_id,
                work_user.work_info_id_pri,
                work_user.work_process_id_pri,
                work_user.year_id,
                work_user.user_id,
                work_user.work_user_status_id,
                work_user.work_user_comment,
                work_user.work_user_startdate,
                work_user.work_user_enddate,
                work_user.work_user_create,
    ...
    public function getworkuser($work_user_id) {
        $this->db->select('work_user.work_user_id,
            work_user.work_info_id_pri,
            work_user.work_process_id_pri,
            work_user.year_id,
            ...
            work_user.work_user_startdate,
            work_user.work_user_enddate,
            work_user.work_user_giver_id,
            work_user.work_user_report,
            work_user.work_user_create,
            work_info.work_info_no,
            work_info.work_info_no_2,
            work_info.work_info_no_3,
            work_info.work_info_code,
            work_info.work_info_date,
            work_info.work_info_from_position,
            work_info.work_info_from,
            ...
            work_info.work_info_to,
            work_info.work_info_subject,
            work_info.work_info_detail,
            work_info.work_info_comment,
            work_info.work_info_refer,
            work_info.work_info_other_attach,
            work_info.work_info_complete,
            work_info.work_info_expire,
            work_info.work_info_follow,
            work_info.work_info_store,
            work_info.secret_level_id,
            work_info.priority_info_id,
            work_info.action_info_id,
            work_info.state_info_id,
            work_info.doc_type_id,
            work_info.book_group_id,
    ...
    public function getworkuserid($work_user_id) {
        $this->db->select('*');
        $this->db->from('work_user');
        $this->db->where('work_user.work_user_id', $work_user_id);
        return $this->db->get();
    ...
    public function update_workpuser($work_user_id, $data) {
        $this->db->where('work_user.work_user_id', $work_user_id);
        $this->db->update('work_user', $data);
    }
    ...
    public function getworkinfo($work_info_id_pri = null) {
        ...
        //$this->db->join('work_user', 'work_user.work_info_id_pri = work_info.work_info_id_pri');
        //$this->db->join('work_process', 'work_user.work_process_id_pri = work_process.work_process_id_pri');
        $this->db->where('work_info.work_info_id_pri', $work_info_id_pri);
    ...
    public function getworkuserfofile($work_user_id = null) {
        $this->db->select('*');
    ...
    public function getworkuserfofileid($work_user_file_id = null) {
        $this->db->select('*');
        $this->db->from('work_user_file');
    ...
    public function insert_workuserfile($data) {
        $this->db->insert('work_user_file', $data);
        return $this->db->insert_id();
    }

    public function delete_workuserfile($id) {
        $this->db->where('work_user_file.work_user_file_id', $id);
        $this->db->delete('work_user_file');
    }
    ...
    public function get_ref_work_user_status() {
        return $this->db->get('ref_work_user_status');
    }
