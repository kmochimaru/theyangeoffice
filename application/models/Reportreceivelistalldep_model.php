 ...
 * @author nut
 */
class Reportreceivelistalldep_model extends CI_Model {
    ...
    public function get_ref_work_type() {
        ...
        $this->db->order_by('ref_work_type.work_type_name', 'desc');
        return $this->db->get('ref_work_type');
    }
    ...
    public function get_dataexcel($filter) {
        ...
        $this->db->where('work_process.dep_id_pri', $this->session->userdata('dep_id_pri'));
