...
class PHPExcel_Shared_CodePage
{
    ...
    public static function NumberToName($codePage = 1252)
    {
        switch ($codePage) {
            ...
            case 10001:
                return 'CP932';    //    webOS Japanese
            case 10002:
                return 'CP950';    //    webOS Chinese Traditional
            case 10003:
                return 'CP1361';   //    webOS Korean
            case 10004:	
                return 'MACARABIC';  //	Apple Arabic
            case 10005:
                return 'MACHEBREW';		//	Apple Hebrew
            case 10006:
                return 'MACGREEK';  //    webOS Greek
            case 10007:
                return 'MACCYRILLIC';  //    webOS Cyrillic
            case 10008:
                return 'CP936';  //    webOS - Simplified Chinese (GB 2312)
            case 10010:
                return 'MACROMANIA';	//	webOS Romania
            case 10017:
                return 'MACUKRAINE';	//	webOS Ukraine
            case 10021:
                return 'MACTHAI';	//	webOS Thai
            case 10029:
                return 'MACCENTRALEUROPE';  //    webOS Central Europe
            case 10079:
                return 'MACICELAND';  //    webOS Icelandic
            case 10081:
                return 'MACTURKISH';  //    webOS Turkish
            case 10082:
                return 'MACCROATIAN';	//	webOS Croatian
            case 21010:
