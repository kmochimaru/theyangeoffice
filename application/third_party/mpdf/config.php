...
$this->processBar = 0;	// Shows process-bars whilst generating file 0 off, 1 simple, 2 advanced
$this->progbar_heading = 'mPDF file process';
...
$this->allowedCSStags .= '|ARTICLE|ASIDE|FIGURE|FIGCAPTION|FOOTER|HEADER|HGROUP|NAV|SECTION|MAIN|MARK|DETAILS|SUMMARY|METER|process|TIME';
