...
class Loguserlogin extends CI_Controller {
   ...
   public function getPagination() {
      ...
      $count = $this->loguserlogin_model->getPagination($filter, array());
      $config['div'] = 'result_pagination';
      $config['base_url'] = base_url('loguserlogin/getpagination');
      ...
      $data = array(
         'data' => $this->loguserlogin_model->getPagination($filter, array('start' => $segment, 'limit' => $this->per_page)),
         'count' => $count,
         'segment' => $segment,
