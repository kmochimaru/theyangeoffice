...
class Reportwithinalldep extends CI_Controller
{
  ...
  public function __construct()
  {
    ...
    $this->load->model('reportwithinalldep_model');
  ...
  public function index()
  {
    ...
    $this->renderView('reportwithinalldep_view', $data);
  }
  ...
  public function ajax_pagination()
  {
    ...
    $count = $this->reportwithinalldep_model->count_pagination($filter);
    $config['div'] = 'result-pagination';
    $config['base_url'] = base_url('reportwithinalldep/ajax_pagination');
    ...
    $data = array(
      'data' => $this->reportwithinalldep_model->get_pagination($filter, array('start' => $segment, 'limit' => $this->per_page)),
      'count' => $count,
      'segment' => $segment,
    ...
    // exit();
    $this->load->view('ajax/reportwithinalldep_pagination', $data);
  }
  ...
  public function excel($year = null, $workTypeId = null, $stateInfoId = null, $bookGroupid = null, $searchText = null, $dateStart = null, $dateEnd = null)
  {
    ...
    $data = $this->reportwithinalldep_model->get_dataexcel($filter);
    ...
    if ($data->num_rows() > 0) {
      foreach ($data->result() as $row) {
        ...
        $sheet->setCellValue("N$r", $this->reportwithinalldep_model->getdep_off_id($row->dep_off_id)->officer_name);
