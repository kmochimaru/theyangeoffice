            ...
            <div class="card-body">
                <h4 class="card-title">
                    ...
                    <span style="float: right">
                        <a href="<?php echo base_url() . 'assignments'; ?>" class="btn btn-sm btn-outline-secondary"><i class="fa fa-arrow-left"></i> กลับ</a>
                    </span>
                </h4>
                <hr>
                <div class="row">
                    <div class="col-md-12 text-left">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 m-t-0">
                                <?php
                                $files = $this->assignments_model->get_workinfofile($data->work_info_id_pri);
                                ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group row">
                                    <span class="col-sm-4 col-form-span" style="font-weight: bold;font-size: 14px;">มอบหมาย :</span>
                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;">
                                        <?php echo $this->assignments_model->get_user($workuser->user_id)->user_fullname; ?>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                <?php
                                $work_process_id_pri = $workuser->work_process_id_pri;
                                $workuserid = $this->assignments_model->getworkprocessworkuserid($workuser->work_user_id);
                                if ($workuserid->num_rows() == 1) {
                                    $work_process_id_pri = $workuserid->row()->work_process_id_pri;
                                } ?>
                                <a href="<?php echo base_url() . 'receivelist/detail/' . $work_process_id_pri . '/1'; ?>" target="_blank" class="btn btn-info"><i class="fa fa-envelope-open"></i> เปิด</a>
                            </div>
                        </div>
                    </div>
                </div>
