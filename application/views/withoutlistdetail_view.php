      ...
      <div class="card-body">
          ...
          <div class="col-md-12 col-sm-12 text-left">
            <div class="row">
              ...
              <div class="col-sm-10 m-t-0">
                <?php
                $files = $this->withoutlist_model->get_workinfofile($data->work_info_id_pri);
                ?>
        ...
        <div class="row">
          <div class="col-md-12 text-right">
            <a href="<?php echo base_url() . 'withoutlist/attach/' . $data->work_info_id_pri; ?>" class="btn btn-info"><i class="mdi mdi-paperclip"></i>&nbsp;เพิ่มไฟล์แนบ</a>
