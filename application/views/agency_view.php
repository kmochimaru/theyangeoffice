...
<script>
    ...
    function ajax_page() {
        ...
        $.ajax({
            url: service_base_url + 'agency/ajax_page',
            type: 'POST',
            data: {
    ...
    function modal_add() {
        $('.modal-content').html('');
        $.ajax({
            url: service_base_url + 'agency/add_modal',
            type: 'POST',
            data: {
    ...
    function modal_edit(agency_id_pri) {
        $('.modal-content').html('');
        $.ajax({
            url: service_base_url + 'agency/edit_modal',
            type: 'POST',
            data: {
                agency_id_pri: agency_id_pri
            },
            success: function (response) {
                $('#result-modal .modal-content').html(response);
                $('#form-modal').parsley().reset();
    ...
    function modal_delete(agency_id_pri) {
        $('.modal-content').html('');
        $.ajax({
            url: service_base_url + 'agency/delete_modal',
            type: 'POST',
            data: {
                agency_id_pri: agency_id_pri
            },
