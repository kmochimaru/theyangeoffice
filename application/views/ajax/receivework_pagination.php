      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'receivework/detail/' . $row->work_user_id . '/1'; ?>" title="เปิด" data-toggle="tooltip"><?php echo $row->work_process_no . $row->work_process_no_2 . $row->work_process_no_3; ?></a>
              <br>
            ...
            <td>
              <?php echo $this->receivework_model->getdep_off($row->work_info_dep_id_pri)->row()->dep_name; ?>
              <br>
              <span class="small"><?php echo $this->receivework_model->getdep_off_id($row->work_info_dep_off_id)->officer_name; ?></span>
            </td>
            <td>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'receivework/detail/' . $row->work_user_id . '/1'; ?>" class="btn btn-sm btn-info" title="เปิด" data-toggle="tooltip"><i class="fa fa-envelope-open"></i> เปิด</a>
            </td>
          </tr>
        <?php
          $i++;
