    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'actingwaiting/edit/' . $row->work_info_id_pri; ?>" title="แก้ไขเอกสาร" data-toggle="tooltip">
            ...
            <td>
              <?php
              $files = $this->actingwaiting_model->get_workinfofile($row->work_info_id_pri);
              if ($files->num_rows() > 0) {
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <?php if ($row->state_info_id == 1) { ?>
                    <a href="<?php echo base_url() . 'actingwaiting/edit/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-edit"></i> แก้ไขเอกสาร</a>
                    <a href="<?php echo base_url() . 'actingwaiting/attach/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="mdi mdi-paperclip"></i> แนบไฟล์เอกสาร</a>
                  ...
                  <?php if ($row->state_info_id == 3) { ?>
                    <a href="<?php echo base_url() . 'actingwaiting/edit/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-edit"></i> แก้ไขเอกสาร</a>
                    <a href="<?php echo base_url() . 'actingwaiting/attach/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="mdi mdi-paperclip"></i> แนบไฟล์เอกสาร</a>
                    <a href="<?php echo base_url() . 'actingwaiting/send/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-send"></i> ส่งเอกสาร</a>
                    <a href="<?php echo base_url() . 'actingwaiting/sendsort/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-send"></i> ส่งตามลำดับเส้นทาง</a>
                    <a href="javascript:void(0)" onclick="modal_changestatus('<?php echo $row->work_info_id_pri; ?>');" class="dropdown-item small"><i class="fa fa-times-circle"></i> ยกเลิกเอกสาร</a>
                  <?php } ?>
