<div class="form-group row">
    ...
    <div class="col-sm-5">
        ...
        <!--                                <div class="form-group row">
                                                                    <span class="col-sm-4 col-form-span" style="font-weight: bold;font-size: 14px;">การลงนาม :</span>
                                                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php //echo$data->ref_internal_action_name;      
                                                                                                                                    ?></span>
                                                                </div>-->
        <!--                                <div class="form-group row">
                                                                    <span class="col-sm-4 col-form-span" style="font-weight: bold;font-size: 14px;">ผู้ลงนาม :</span>
                                                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php //echo ($data->internal_action_name != '' ? $data->internal_action_name : '-');      
                                                                                                                                    ?></span>
                                                                </div>-->
        <!--                                <div class="form-group row">
                                                                    <span class="col-sm-4 col-form-span" style="font-weight: bold;font-size: 14px;">วิธีการรับ-ส่งเอกสาร :</span>
                                                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php //echo $data->doc_type_name;      
                                                                                                                                    ?></span>
                                                                </div>                                -->
        <!--                                <div class="form-group row">
                                                                    <span class="col-sm-4 col-form-span" style="font-weight: bold;font-size: 14px;">ที่เก็บเอกสาร :</span>
                                                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php //echo ($data->work_info_store != '' ? $data->work_info_store : '-');      
                                                                                                                                    ?></span>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <span class="col-sm-4 col-form-span" style="font-weight: bold;font-size: 14px;">อายุเอกสาร :</span>
                                                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php //echo ($data->work_info_expire != '' ? $data->work_info_expire : '-');      
                                                                                                                                    ?></span>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <span class="col-sm-4 col-form-span" style="font-weight: bold;font-size: 14px;">ดำเนินการแล้วเสร็จภายในวันที่ :</span>
                                                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php //echo ($data->work_info_complete != '' ? $data->work_info_complete : '-');      
                                                                                                                                    ?></span>
                                                                </div>-->
        <div class="form-group row">
