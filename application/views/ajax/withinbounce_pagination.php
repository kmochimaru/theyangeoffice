    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'withinbounce/detail/' . $row->work_process_id_pri . '/1'; ?>" title="รายละเอียด">
            ...
            <td>
              <?php
              $files = $this->withinbounce_model->get_workinfofile($row->work_info_id_pri);
              if ($files->num_rows() > 0) {
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'withinbounce/detail/' . $row->work_process_id_pri . '/1'; ?>" class="btn btn-sm btn-info"><i class="fa fa-envelope-open"></i>&nbsp;เปิด</a>
            </td>
          </tr>
        <?php
          $i++;
