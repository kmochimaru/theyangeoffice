        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <!-- <td>
                            <?php
                            // $files = $this->reportwithinalldep_model->get_workinfofile($row->work_info_id_pri);
                            // if ($files->num_rows() > 0) {
                        ...
                        <td>
                            ...
                            <span class="small"><?php echo $this->reportwithinalldep_model->getdep_off_id($row->dep_off_id)->officer_name; ?></span>
                        </td>
                    </tr>
                <?php
                    $i++;
