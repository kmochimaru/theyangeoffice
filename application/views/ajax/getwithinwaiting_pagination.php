  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <th width="28%">เรื่อง</th>
        <th width="12%">แนบไฟล์</th>
    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'getwithinwaiting/edit/' . $row->work_info_id_pri; ?>" title="แก้ไขเอกสาร" data-toggle="tooltip">
            ...
            <td>
              <?php
              $files = $this->getwithinwaiting_model->get_workinfofile($row->work_info_id_pri);
              if ($files->num_rows() > 0) {
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <?php if ($row->state_info_id == 1) { ?>
                    <a href="<?php echo base_url() . 'getwithinwaiting/edit/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-edit"></i> แก้ไขเอกสาร</a>
                    <a href="<?php echo base_url() . 'getwithinwaiting/attach/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="mdi mdi-paperclip"></i> แนบไฟล์เอกสาร</a>
                  ...
                  <?php if ($row->state_info_id == 2) { ?>
                    <a href="<?php echo base_url() . 'getwithinwaiting/edit/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-edit"></i> แก้ไขเอกสาร</a>
                    <a href="<?php echo base_url() . 'getwithinwaiting/attach/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="mdi mdi-paperclip"></i> แนบไฟล์เอกสาร</a>
                    <!-- <a href="javascript:void(0)" onclick="modal_regisnumber('<?php echo $row->work_info_id_pri; ?>');" class="dropdown-item small"><i class="fa fa-check-square-o"></i> ลงทะเบียนเอกสาร</a> -->
                    <a href="javascript:void(0)" onclick="modal_changestatus('<?php echo $row->work_info_id_pri; ?>');" class="dropdown-item small"><i class="fa fa-times-circle"></i> ยกเลิกเอกสาร</a>
                  <?php } ?>
                  <?php if ($row->state_info_id == 3) { ?>
                    <a href="<?php echo base_url() . 'getwithinwaiting/edit/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-edit"></i> แก้ไขเอกสาร</a>
                    <a href="<?php echo base_url() . 'getwithinwaiting/attach/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="mdi mdi-paperclip"></i> แนบไฟล์เอกสาร</a>
                    <a href="<?php echo base_url() . 'getwithinwaiting/send/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-send"></i> ส่งเอกสาร</a>
                    <a href="<?php echo base_url() . 'getwithinwaiting/sendsort/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-send"></i> ส่งตามลำดับเส้นทาง</a>
                    <a href="javascript:void(0)" onclick="modal_changestatus('<?php echo $row->work_info_id_pri; ?>');" class="dropdown-item small"><i class="fa fa-times-circle"></i> ยกเลิกเอกสาร</a>
                  <?php } ?>
                  <a href="<?php echo base_url() . 'printout/docketinfo/' . $row->work_info_code; ?>" class="dropdown-item small fancyboxpdf" target="_blank"><i class="fa fa-print"></i> พิมพ์เอกสาร</a>
                </div>
              </div>
            </td>
          </tr>
