    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td>
              <label class="badge badge-dark"><?php echo $this->servieclist_model->ref_service_status($row->service_status_id)->row()->service_status_name; ?></label>
            </td>
            <td><?php echo $this->servieclist_model->get_help_desk_active($row->service_id, $this->session->userdata('user_id'))->num_rows() == 1 ? '<i class="fa fa-star text-warning"></i> ' : ''; ?><?php echo $row->service_name; ?></td>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'servieclist/detail/' . $row->service_info_id_pri; ?>" class="btn btn-sm btn-outline-info"><i class="fa fa-tasks"></i> รายละเอียด</a>
            </td>
          </tr>
        <?php
          $i++;
