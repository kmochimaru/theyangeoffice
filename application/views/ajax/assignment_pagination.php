      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'assignment/detail/' . $row->work_user_id . '/1'; ?>" title="เปิด" data-toggle="tooltip"><?php echo $row->work_process_no . $row->work_process_no_2 . $row->work_process_no_3; ?></a>
              <br>
            ...
            <td>
              <?php echo $this->assignment_model->getdep_off($row->work_info_dep_id_pri)->row()->dep_name; ?>
              <br>
              <span class="small"><?php echo $this->assignment_model->getdep_off_id($row->work_info_dep_off_id)->officer_name; ?></span>
            </td>
            <td>
            ...
            <td>
              <?php
              $dep_off_id = $this->assignment_model->getdep_off_id($this->assignment_model->getworkprocess($row->work_process_id_pri)->row()->dep_off_id);
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'assignment/detail/' . $row->work_user_id; ?>" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i> แสดงงาน</a>
            </td>
          </tr>
        <?php
          $i++;
