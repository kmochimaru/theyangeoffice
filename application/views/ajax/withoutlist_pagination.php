  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <th width="14%">ปีเอกสาร / ลงวันที่</th>
        <th width="12%">ประเภทเอกสาร</th>
        <th>เรื่อง</th>
    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'withoutlist/detail/' . $row->work_info_code; ?>" title="รายละเอียด">
            ...
            <td>
              <?php echo $this->withoutlist_model->ref_work_type($row->work_type_id)->row()->work_type_name; ?>
            </td>
            <td>
            ...
            <td>
              <?php
              $files = $this->withoutlist_model->get_workinfofile($row->work_info_id_pri);
              if ($files->num_rows() > 0) {
            ...
            <td class="text-center">
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <a href="<?php echo base_url() . 'withoutlist/detail/' . $row->work_info_code; ?>" class="dropdown-item small"><i class="fa fa-list"></i> รายละเอียด</a>
                  <?php if ($row->state_info_id == 1) { ?>
                    <a href="<?php echo base_url() . 'withoutlist/edit/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-edit"></i> แก้ไขเอกสาร</a>
                    <a href="<?php echo base_url() . 'withoutlist/attach/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-paperclip"></i> แนบไฟล์เอกสาร</a>
