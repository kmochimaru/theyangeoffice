...
<input type="hidden" id="state_info_id" value="<?php echo $state_info_id; ?>" />
<div class="row" id="sortable-image-list">
  ...
  ?>
      <div class="col-lg-2">
        <div class="row">
          ...
          <div class="col-lg-12 text-center">
            <a style="padding: 0px" href="<?php echo base_url() . 'store/file/' . $data->work_info_file_id; ?>" title="<?php echo $data->work_info_file_oldname; ?>" class="<?php echo ($data->file_type_check != 2) ? ($data->file_type_check != 1) ? 'fancybox' : 'fancyboxpdf' : ''; ?>" target="_blank">
    ...
    ?>
    <div class="col-md-12 text-center m-t-30" style="color: #999;">
