        ...
        <tbody>
            ...
            ?>
                        <tr>
                            ...
                            <td>
                                <?php echo $this->reportreceivelistdep_model->getdep_off($row->work_info_dep_id_pri)->row()->dep_name; ?>
                                <br>
                                <span class="small"><?php echo $this->reportreceivelistdep_model->getdep_off_id($row->work_info_dep_off_id)->officer_name; ?></span>
                            </td>
                            <td>
                            ...
                            <?php if ($row->work_process_receive == 1) { ?>
                                <td><?php echo $row->work_process_receive_name; ?>
                                    <br>
                                    <span class="small"><?php echo $this->reportreceivelistdep_model->getdep_off_id($row->dep_off_id)->officer_name; ?></span>
                                </td>
