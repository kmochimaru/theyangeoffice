    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'followme/detail/' . $row->work_info_code; ?>" title="รายละเอียด">
            ...
            <td>
              <?php
              $files = $this->followme_model->get_workinfofile($row->work_info_id_pri);
              if ($files->num_rows() > 0) {
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'followme/detail/' . $row->work_info_code; ?>" title="รายละเอียด" class="btn btn-outline-info btn-sm"><i class="fa fa-navicon"></i> รายละเอียด</a>
            </td>
          </tr>
        <?php
          $i++;
