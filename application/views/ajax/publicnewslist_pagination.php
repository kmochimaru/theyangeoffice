      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'publicnewslist/detail/' . $row->work_info_code; ?>" title="รายละเอียด">
            ...
            <td>
              <?php
              $files = $this->publicnewslist_model->get_workinfofile($row->work_info_id_pri);
              if ($files->num_rows() > 0) {
            ...
            <td class="text-center" style="font-weight: bold;">
              ...
              <?php } else if ($row->state_info_id == 2) { ?>
                <span class="badge badge-primary"><i class="fa fa-edit"></i> <?php echo 'รอประกาศ'; ?></span>
              <?php } else { ?>
            ...
            <td class="text-center">
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <a href="<?php echo base_url() . 'publicnewslist/detail/' . $row->work_info_code; ?>" class="dropdown-item small"><i class="fa fa-list"></i> รายละเอียด</a>
                  <?php if ($row->state_info_id == 1) { ?>
                    <a href="<?php echo base_url() . 'publicnewslist/edit/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-edit"></i> แก้ไขเอกสาร</a>
                    <a href="<?php echo base_url() . 'publicnewslist/attach/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-paperclip"></i> แนบไฟล์เอกสาร</a>
                  ...
                  <?php if ($row->state_info_id == 2) { ?>
                    <a href="<?php echo base_url() . 'publicnewslist/edit/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-edit"></i> แก้ไขเอกสาร</a>
                    <a href="<?php echo base_url() . 'publicnewslist/attach/' . $row->work_info_id_pri; ?>" class="dropdown-item small"><i class="fa fa-paperclip"></i> แนบไฟล์เอกสาร</a>
                    <a href="javascript:void(0)" onclick="modal_regisnumber('<?php echo $row->work_info_id_pri; ?>');" class="dropdown-item small"><i class="fa fa-check-square-o"></i> ประกาศประชาสัมพันธ์</a>
                    <a href="javascript:void(0)" onclick="modal_changestatus('<?php echo $row->work_info_id_pri; ?>');" class="dropdown-item small"><i class="fa fa-times-circle"></i> ยกเลิกเอกสาร</a>
                  <?php } ?>
