    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?php echo base_url() . 'withinprocess/detail/' . $row->work_process_id_pri; ?>" title="รายละเอียด" data-toggle="tooltip">
            ...
            <td>
              <?php $dep_off = $this->withinprocess_model->getdep_off_id($row->work_process_dep_off_id); ?>
            ...
            <td class="text-center" style="font-weight: bold;">
              ...
              <?php } ?>
              <?php
              $checks = $this->withinprocess_model->checkwithinprocess($row->work_info_id_pri, ($row->work_process_sort - 1), 0);
            ...
            <td class="text-center">
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <a href="<?php echo base_url() . 'withinprocess/detail/' . $row->work_process_id_pri; ?>" class="dropdown-item small"><i class="fa fa-navicon"></i> รายละเอียด</a>
                  <a href="<?php echo base_url() . 'withinprocess/attach/' . $row->work_process_id_pri; ?>" class="dropdown-item small"><i class="fa fa-paperclip"></i> เพิ่มไฟล์เอกสาร</a>
                  <?php if ($row->work_process_receive != 1) { ?>
