    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <form id="form-edit" class="form-horizontal" method="post" action="<?php echo base_url() . 'retrospectlist/editretrospect'; ?>" autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="work_type_id" id="work_type_id" class="form-control form-control-sm">
                                        <?php foreach ($this->retrospectlist_model->ref_work_type()->result() as $work_type) { ?>
                                            <option value="<?php echo $work_type->work_type_id; ?>" <?php $data->work_type_id == $work_type->work_type_id ? 'selected' : ''; ?>><?php echo $work_type->work_type_name; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" min="0" step="1" name="work_info_id" value="<?php echo $data->work_info_id; ?>" class="form-control form-control-sm" required="">
                                </div>
                            </div>
                            <?php $department = $this->retrospectlist_model->getDepartment($this->session->userdata('dep_id_pri'))->row(); ?>
                            <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="priority_info_id" class="form-control form-control-sm">
                                        <?php foreach ($this->retrospectlist_model->ref_priority_info()->result() as $priority_info) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="secret_level_id" class="form-control form-control-sm">
                                        <?php foreach ($this->retrospectlist_model->ref_secret_level()->result() as $secret_level) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="book_group_id" class="form-control form-control-sm">
                                        <?php foreach ($this->retrospectlist_model->ref_book_group()->result() as $book_group) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="action_info_id" class="form-control form-control-sm">
                                        <?php foreach ($this->retrospectlist_model->ref_action_info()->result() as $action_info) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <textarea type="text" name="work_info_comment" class="form-control form-control-sm" rows="6"><?php echo $data->work_info_comment; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-right">
                            <a href="<?php echo base_url() . 'retrospectlist/attach/' . $work_info_id_pri; ?>" class="btn btn-secondary"><i class="fa fa-paperclip"></i>&nbsp;แนบไฟล์</a>
