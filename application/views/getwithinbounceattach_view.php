            ...
            <div class="card-body">
                ...
                <div id="close_upload">
                    ...
                    <div class=" col-md-12 text-right">
                        <a href="<?php echo base_url() . 'getwithinbounce/detail/' . $work_process_id_pri; ?>" id class="btn btn-warning"><i class="fa fa-check-circle-o"></i>&nbsp;อัพโหลดเสร็จสิ้น</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function upload_attach() {
        ...
        url = service_base_url + 'getwithinbounce/upload_attach/' + $('#work_process_id_pri').val();
        $.ajax({
            url: url,
            type: 'POST',
            contentType: false,
    ...
    function ajax_page() {
        ...
        $('#result_page').html('<div style="text-align:center; padding:80px;"><i class="fa fa-refresh fa-spin fa-3x fa-fw"></i></div>');
        $.ajax({
            url: service_base_url + 'getwithinbounce/ajax_page',
            type: 'post',
            data: {
    ...
    function delete_file(id, name) {
        url = service_base_url + 'getwithinbounce/delete_file';
        $.ajax({
            url: url,
            method: 'POST',
            data: {
