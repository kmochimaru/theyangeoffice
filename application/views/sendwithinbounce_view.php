                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group row">
                                    ...
                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php echo $this->withinbounce_model->ref_work_type($data->work_type_id)->row()->work_type_name; ?></span>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php echo $this->withinbounce_model->ref_priority_info($data->priority_info_id)->row()->priority_info_name; ?></span>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-4 col-form-span" style="font-weight: bold;font-size: 14px;">ชั้นความลับ :</span>
                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php echo $this->withinbounce_model->ref_secret_level($data->secret_level_id)->row()->secret_level_name; ?></span>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-4 col-form-span" style="font-weight: bold;font-size: 14px;">หมวดเอกสาร :</span>
                                    <span class="col-sm-7 col-form-span" style="font-size: 14px;"><?php echo $this->withinbounce_model->ref_book_group($data->book_group_id)->row()->book_group_name; ?></span>
                                </div>
                    ...
                    <div class="row">
                        <div class=" col-md-12 text-left">
                            ...
                            <select id="def_id_pri" name="def_id_pri_select[]" multiple="multiple">
                                <?php
                                $orgs = $this->withinbounce_model->getOrganization();
                                if ($orgs->num_rows() > 0) {
                                    foreach ($orgs->result() as $org) {
                                        $deps = $this->withinbounce_model->getOrgDepartment($org->org_id_pri);
                                        if ($deps->num_rows() > 0) {
                                            foreach ($deps->result() as $dep) {
                                                $dep_offs = $this->withinbounce_model->getDepOffSend($dep->dep_id_pri);
...
<script>
    ...
    $('#from_add').submit(function(e) {
        ...
        $.ajax({
            url: '<?php echo base_url() . 'withinbounce/sendto'; ?>',
            type: 'POST',
            data: postData,
            processData: false,
            contentType: false,
