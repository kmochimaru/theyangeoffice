    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <form id="form-edit" class="form-horizontal" method="post" action="<?php echo base_url() . 'withoutlist/editwithout'; ?>" autocomplete="off">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <input type="text" name="work_type_name" value="<?php echo $this->withoutlist_model->ref_work_type($data->work_type_id)->row()->work_type_name ?>" class="form-control form-control-sm" readonly="">
                                </div>
                            </div>
                            <div class="form-group row">
...
<!--                                    <div class="row">
                                        <div class="col-sm-9">-->
                                            <?php $department = $this->withoutlist_model->getDepartment($this->session->userdata('dep_id_pri'))->row(); ?>
                                            <input type="text" name="work_info_no" value="<?php echo $data->work_info_no; ?>" class="form-control form-control-sm" required="">
<!--                                        </div>
                                        <div class="col-sm-3">
                                            <span style="font-size: 15px;"><?php echo $data->work_info_no_3; ?></span>
                                        </div>
                                    </div>-->
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="work_info_from_position" class="form-control form-control-sm">
                                        <option value=""></option>
                                        <?php foreach ($this->withoutlist_model->ref_position()->result() as $position_from) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="work_info_to_position" id="work_info_to_position" value="<?php echo $data->work_info_to_position; ?>" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <textarea type="text" name="work_info_subject" class="form-control form-control-sm"><?php echo $data->work_info_subject; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="priority_info_id" class="form-control form-control-sm">
                                        <?php foreach ($this->withoutlist_model->ref_priority_info()->result() as $priority_info) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="secret_level_id" class="form-control form-control-sm">
                                        <?php foreach ($this->withoutlist_model->ref_secret_level()->result() as $secret_level) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="book_group_id" class="form-control form-control-sm">
                                        <?php foreach ($this->withoutlist_model->ref_book_group()->result() as $book_group) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="action_info_id" class="form-control form-control-sm">
                                        <?php foreach ($this->withoutlist_model->ref_action_info()->result() as $action_info) { ?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-right">
                            <a href="<?php echo base_url() . 'withoutlist/attach/' . $work_info_id_pri; ?>" class="btn btn-secondary"><i class="fa fa-paperclip"></i>&nbsp;แนบไฟล์</a>
