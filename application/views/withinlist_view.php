            ...
            <div class="card-body">
                <h4 class="card-title">
                    ...
                    <span style="float: right">
                        <a href="<?php echo base_url() . 'within'; ?>" class="btn btn-sm btn-rounded btn-outline-success"><i class="fa fa-plus"></i> สร้างหนังสือส่งภายใน</a>
                    </span>
                </h4>
                <div class="row m-t-20">
                    ...
                    <div class="col-sm-2 m-b-10">
                        ...
                        <select id="state_info_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $states = $this->withinlist_model->get_ref_state_info();
                    ...
                    <div class="col-sm-2 m-b-10">
                        ...
                        <select id="book_group_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $groups = $this->withinlist_model->get_ref_book_group();
...
<script>
    ...
    function ajax_pagination() {
        ...
        $.ajax({
            url: service_base_url + 'withinlist/ajax_pagination',
            type: 'POST',
            data: {
                year_id: $('#year_id').val(),
    ...
    function modal_changestatus(work_info_id_pri) {
        $.ajax({
            url: service_base_url + 'withinlist/modal_changestatus',
            type: 'POST',
            data: {
    ...
    function changestatus(work_info_id_pri) {
        ...
        if (form.parsley().isValid() == true) {
            ...
            $.ajax({
                url: service_base_url + 'withinlist/changestatus',
                type: 'POST',
                data: {
                    work_info_id_pri: work_info_id_pri,
