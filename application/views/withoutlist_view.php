            ...
            <div class="card-body">
                <h4 class="card-title">
                    ...
                    <span style="float: right">
                        <a href="<?php echo base_url() . 'without'; ?>" class="btn btn-sm btn-rounded btn-outline-success"><i class="fa fa-plus"></i> สร้างหนังสือส่งภายนอก</a>
                    </span>
                </h4>
                <div class="row m-t-20">
                    ...
                    <div class="col-sm-2 m-b-10">
                        ...
                        <select id="state_info_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $states = $this->withoutlist_model->get_ref_state_info();
                    ...
                    <div class="col-sm-2 m-b-10">
                        ...
                        <select id="work_type_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $types = $this->withoutlist_model->ref_work_type();
                            if ($types->num_rows() > 0) {
                                foreach ($types->result() as $type) {
                            ?>
                                    <option value="<?php echo $type->work_type_id; ?>"><?php echo $type->work_type_name; ?></option>
                            <?php
                                }
                            }
                            ?>
                    ...
                    <div class="col-sm-2 m-b-10">
                        ...
                        <select id="book_group_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $groups = $this->withoutlist_model->get_ref_book_group();
...
<script>
    ...
    function ajax_pagination() {
        ...
        $.ajax({
            url: service_base_url + 'withoutlist/ajax_pagination',
            type: 'POST',
            data: {
                year_id: $('#year_id').val(),
    ...
    function modal_changestatus(work_info_id_pri) {
        $.ajax({
            url: service_base_url + 'withoutlist/modal_changestatus',
            type: 'POST',
            data: {
    ...
    function changestatus(work_info_id_pri) {
        ...
        $('#btn-modal-submit-loading').show();
        $.ajax({
            url: service_base_url + 'withoutlist/changestatus',
            type: 'POST',
            data: {
                work_info_id_pri: work_info_id_pri,
