                ...
                <div class="row m-t-20">
                    ...
                    <div class="col-sm-3 m-b-10">
                        ...
                        <select id="work_type_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $work_types = $this->reportwithinalldep_model->get_ref_work_type();
                    ...
                    <div class="col-sm-3 m-b-10">
                        ...
                        <select id="state_info_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $states = $this->reportwithinalldep_model->get_ref_state_info();
                    ...
                    <div class="col-sm-3 m-b-10">
                        ...
                        <select id="book_group_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $groups = $this->reportwithinalldep_model->get_ref_book_group();
...
<script>
    ...
    function Exportexcel() {
        ...
        window.open(service_base_url + 'reportwithinalldep/excel/' + params, '_blank');
    }

    function ajax_pagination() {
        $('#result-pagination').html('<div style="text-align:center; padding:80px;"><i class="fa fa-refresh fa-spin fa-3x fa-fw"></i></div>');
        $.ajax({
            url: service_base_url + 'reportwithinalldep/ajax_pagination',
            type: 'POST',
            data: {
                year_id: $('#year_id').val(),
    ...
    function modal_changestatus(work_info_id_pri) {
        $.ajax({
            url: service_base_url + 'reportwithinalldep/modal_changestatus',
            type: 'POST',
            data: {
    ...
    function changestatus(work_info_id_pri) {
        ...
        if (form.parsley().isValid() == true) {
            ...
            $.ajax({
                url: service_base_url + 'reportwithinalldep/changestatus',
                type: 'POST',
                data: {
                    work_info_id_pri: work_info_id_pri,
    ...
    function modal_closestatus(work_info_id_pri) {
        $.ajax({
            url: service_base_url + 'reportwithinalldep/modal_closestatus',
            type: 'POST',
            data: {
                work_info_id_pri: work_info_id_pri
            },
    ...
    function closestatus(work_info_id_pri) {
        ...
        $('#btn-modal-submit-loading').show();
        $.ajax({
            url: service_base_url + 'reportwithinalldep/closestatus',
            type: 'POST',
            data: {
                work_info_id_pri: work_info_id_pri,
            },
