<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form id="form-add"  class="form-horizontal" method="post" action="<?php echo base_url() . 'acting/add'; ?>" autocomplete="off">
                    <h4 class="card-title">
                        <div class="row">
                            <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5"> 
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7"> 
                                    <input type="hidden" name="work_type_id" value="5" class="form-control form-control-sm">
                                    <input type="text" name="work_type_name" value="<?php echo $this->acting_model->ref_work_type(5)->row()->work_type_name ?>" class="form-control form-control-sm" readonly="">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">   
                                    <div class="row">
                                        <div class="col-sm-5" style="padding-right: 2px;">    
                                            <?php $department = $this->acting_model->getDepartment($this->session->userdata('dep_id_pri'))->row(); ?>
                                        ...
                                        <div class="col-sm-3" style="padding-right: 0px; padding-left: 8px; padding-top: 4px;"> 
                                            <?php $dep_year = $this->acting_model->getDepartmentyear($this->session->userdata('dep_id_pri')); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7"> 
                                    <select name="work_info_from_position" class="form-control form-control-sm">
                                        <option value=""></option>
                                        <?php foreach ($this->acting_model->ref_position()->result() as $position_from) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7"> 
                                    <select name="work_info_to_position" class="form-control form-control-sm">
                                        <?php foreach ($this->acting_model->ref_position(1)->result() as $position_to) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">                              
                                    <input type="text" name="work_info_to" id="work_info_to" value="<?php echo $this->acting_model->getOrganization()->row()->org_name; ?>" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">                              
                                    <select name="priority_info_id" class="form-control form-control-sm">
                                        <?php foreach ($this->acting_model->ref_priority_info()->result() as $priority_info) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">                              
                                    <select name="secret_level_id" class="form-control form-control-sm">
                                        <?php foreach ($this->acting_model->ref_secret_level()->result() as $secret_level) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">                              
                                    <select name="book_group_id" class="form-control form-control-sm">
                                        <?php foreach ($this->acting_model->ref_book_group()->result() as $book_group) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">                              
                                    <select name="action_info_id" class="form-control form-control-sm">
                                        <?php foreach ($this->acting_model->ref_action_info()->result() as $action_info) { ?>
                                ...
                                <div class="col-sm-7">  
                                    <div class="m-b-10">
                                        <label class="custom-control custom-radio">
                                            <input name="attach_original" id="radio1" type="radio" value="0" class="custom-control-input" required="">
                                            <span class="custom-control-label">&nbsp; ไม่ส่งต้นฉบับ</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            <input name="attach_original" id="radio2" type="radio" value="1" checked="checked" class="custom-control-input" required="">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title"> ยืนยันการร่างหนังสือรักษาการ</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                </div>
                                <div class="modal-body">
                                    <div class="bootbox-body text-center">
                                        <p class="text-center" style="font-weight: bold;">ยืนยันการร่างหนังสือรักษาการ</p>
                                    </div>
                                </div>
