                ...
                <div class="row m-t-20">
                    ...
                    <div class="col-sm-2 m-b-10">
                        ...
                        <select id="priority_info_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $prioritys = $this->withinprocess_model->ref_priority_info();
                    ...
                    <div class="col-sm-2 m-b-10">
                        ...
                        <select id="book_group_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $groups = $this->withinprocess_model->get_ref_book_group();
...
<script>
    ...
    function ajax_pagination() {
        ...
        $.ajax({
            url: service_base_url + 'withinprocess/ajax_pagination',
            type: 'POST',
            data: {
                year_id: $('#year_id').val(),
    ...
    function modal_changestatus(work_process_id_pri) {
        $.ajax({
            url: service_base_url + 'withinprocess/modal_changestatus',
            type: 'POST',
            data: {
    ...
    function changestatus(work_process_id_pri) {
        ...
        $.ajax({
            url: service_base_url + 'withinprocess/changestatus',
            type: 'POST',
            data: {
                work_process_id_pri: work_process_id_pri
            },
