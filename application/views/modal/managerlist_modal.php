<form id="form-serial-delete" method="post" autocomplete="false" action="#">
    ...
    <div class="modal-footer">
        <button type="button" id="btn_submit" class="btn btn-info" onclick="receivelist('<?php echo $work_process_id_pri; ?>')"><span id="btn-modal-submit-loading" style="display: none;"><i class="fa fa-spinner fa-spin"></i> </span> ลงรับเอกสาร</button>
