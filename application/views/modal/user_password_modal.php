<form id="form-modal" method="post" action="<?php echo base_url('user/password_user'); ?>" autocomplete="off">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="password" id="password_new" name="password_new" class="form-control form-control-sm" onblur="check_password()" required="" autocomplete="new_password">
        </div>
        <div class="form-group">
            <label class="control-label">Password ( ยืนยัน ) <span class="text-danger">*</span></label>
            <input type="password" id="password_confirm" name="password_confirm" class="form-control form-control-sm" onblur="check_password()" required="" autocomplete="new_password2">
        </div>
    </div>
