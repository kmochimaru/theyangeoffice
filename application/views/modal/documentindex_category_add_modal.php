<form id="form-modal" method="post" action="<?php echo base_url('documentindexref/add_category'); ?>" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" name="ref_doc_index_category_code" class="form-control form-control-sm" required="">
        </div>
        <div class="form-group">
            <label class="control-label">ชื่อประเภทเอกสาร <span class="text-danger">*</span></label>
            <input type="text" name="ref_doc_index_category_name" class="form-control form-control-sm" required="">
        </div>
    </div>
