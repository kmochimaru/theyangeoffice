<form id="form-modal" method="post" action="<?php echo base_url('documentindexref/add_store1'); ?>" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" name="ref_doc_index_store1_code" class="form-control form-control-sm" required="">
        </div>
        <div class="form-group">
            <label class="control-label">ชื่อลักษณะจัดเก็บ <span class="text-danger">*</span></label>
            <input type="text" name="ref_doc_index_store1_name" class="form-control form-control-sm" required="">
        </div>
    </div>
