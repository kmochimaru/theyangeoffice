...
$data = $this->department_model->getDepartment($dep_id_pri)->row();
?>
<form id="form_department" method="post" onsubmit="return editdepartment();" autocomplete="false">
    <input type="hidden" name="dep_id_pri" id="dep_id_pri" value="<?php echo $dep_id_pri ?>" class="form-control form-control-sm" required="">
    <div class="modal-header">
        <h4 class="modal-title"><i class="fa fa-edit"></i> แก้ไขหน่วยงาน</h4>
    ...
    <div class="modal-body">
        ...
        <div class="row form-group">
            <div class="col-lg-6">
                ...
                <input type="text" name="dep_id" id="dep_id" value="<?php echo $data->dep_id; ?>" class="form-control form-control-sm" required="">
            </div>
            <div class="col-lg-6">
                <label class="control-label">ชื่อย่อหน่วยงาน <span class="text-danger">*</span></label>
                <input type="text" name="dep_name_short" id="dep_name_short" value="<?php echo $data->dep_name_short; ?>" class="form-control form-control-sm" required="">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-lg-12">
                <label class="control-label">ชื่อหน่วยงาน <span class="text-danger">*</span></label>
                <input type="text" name="dep_name" id="dep_name" value="<?php echo $data->dep_name; ?>" class="form-control form-control-sm" required="">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-lg-12">
                <label class="control-label">ลักษณะหน่วยงาน <span class="text-danger">*</span></label>
                <input type="text" name="dep_description" id="dep_description" value="<?php echo $data->dep_description; ?>" class="form-control form-control-sm" required="">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-lg-12">
                <label class="control-label">เบอ์โทรติดต่อ <span class="text-danger">*</span></label>
                <input type="text" name="dep_tel" id="dep_tel" value="<?php echo $data->dep_tel; ?>" class="form-control form-control-sm" required="">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-lg-6">
                <label class="control-label">รหัสนำหน้าหนังสือส่งออกภายใน <span class="text-danger">*</span></label>
                <input type="text" name="dep_prefix_within" id="dep_prefix_within" value="<?php echo $data->dep_prefix_within; ?>" class="form-control form-control-sm" required="">
            </div>
            <div class="col-lg-6">
                <label class="control-label">รหัสนำหน้าหนังสือส่งออกภายนอก <span class="text-danger">*</span></label>
                <input type="text" name="dep_prefix_without" id="dep_prefix_without"  value="<?php echo $data->dep_prefix_without; ?>" class="form-control form-control-sm" required="">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-lg-6">                              
                <input name="dep_without_active_id" id="dep_without_active_id" type="checkbox" value="1" <?php echo ($data->dep_without_active_id == 1) ? 'checked' : ''; ?> class="filled-in chk-col-red">
...
<script>
    function editdepartment() {
        ...
        if (form.parsley().isValid() == true) {
            ...
            $.ajax({
                url: service_base_url + 'department/editdepartment',
                method: "POST",
                data: {
