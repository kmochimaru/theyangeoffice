<form id="form-modal" method="post" action="<?php echo base_url('actioninfo/add'); ?>" autocomplete="off">
    <div class="modal-header">
        <h4 class="modal-title"><i class="fa fa-plus"></i> เพิ่มวัตถุประสงค์</h4>
    ...
    <div class="modal-body">
        <div class="row form-group">
            <div class="col-lg-12">
                ...
                <input type="text" name="action_info_name" class="form-control form-control-sm" required="">
            </div>
        </div>   
    </div>
