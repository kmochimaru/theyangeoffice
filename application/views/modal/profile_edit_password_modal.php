...
<div class="modal-body">
    <div class="bootbox-body">
        <form class="form-horizontal" id="formeditpassword" method="post" autocomplete="off">            
            ...
            <p class="text-center text-danger col-sm-12" id="statuspassword"></p>
            <div class="form-group row">
            ...
            <p class="text-center text-danger col-sm-12" id="statusconfirmpassword"></p>
            <div class="form-group row">
            ...
            <div class="form-group">
                <div class="col-md-12 text-center">
                    <button type="button" value="bt-submit" id="bt-submit" class="btn btn-info waves-effect waves-light"><i class="fa fa-save"></i>&nbsp;บันทึก</button>
                    &nbsp;
...
<script>
    ...
    $('#bt-submit').click(function() {
        if ($('#formeditpassword').parsley().validate() === true) {
            editpassword();
        }
        return false;
    })
