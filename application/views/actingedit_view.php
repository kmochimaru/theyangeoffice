            ...
            <div class="card-body">
                <h4 class="card-title">
                    ...
                    <span style="float: right">
                        <a href="<?php echo base_url() . 'actingwaiting'; ?>" class="btn btn-sm btn-outline-secondary"><i class="fa fa-arrow-left"></i> กลับ</a>
                    </span>
                </h4>
                <hr>
                <form id="form-edit"  class="form-horizontal" method="post" action="<?php echo base_url() . 'actingwaiting/editacting'; ?>" autocomplete="off">
                        ...
                        <div class="col-sm-5"> 
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7"> 
                                    ...
                                    <input type="text" name="work_type_name" value="<?php echo $this->actingwaiting_model->ref_work_type(2)->row()->work_type_name ?>" class="form-control form-control-sm" readonly="">
                                </div>
                            </div>
                            <?php $department = $this->actingwaiting_model->getDepartment($this->session->userdata('dep_id_pri'))->row(); ?>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7"> 
                                    <select name="work_info_from_position" class="form-control form-control-sm">
                                        <option value=""></option>
                                        <?php foreach ($this->actingwaiting_model->ref_position()->result() as $position_from) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7"> 
                                    <select name="work_info_to_position" class="form-control form-control-sm">
                                        <?php foreach ($this->actingwaiting_model->ref_position(1)->result() as $position_to) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">                              
                                    <select name="priority_info_id" class="form-control form-control-sm">
                                        <?php foreach ($this->actingwaiting_model->ref_priority_info()->result() as $priority_info) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">                              
                                    <select name="secret_level_id" class="form-control form-control-sm">
                                        <?php foreach ($this->actingwaiting_model->ref_secret_level()->result() as $secret_level) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">                              
                                    <select name="book_group_id" class="form-control form-control-sm">
                                        <?php foreach ($this->actingwaiting_model->ref_book_group()->result() as $book_group) { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">                              
                                    <select name="action_info_id" class="form-control form-control-sm">
                                        <?php foreach ($this->actingwaiting_model->ref_action_info()->result() as $action_info) { ?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-right">
                            <a href="<?php echo base_url() . 'actingwaiting/attach/' . $work_info_id_pri; ?>" class="btn btn-secondary"><i class="mdi mdi-paperclip"></i>&nbsp;แนบไฟล์</a>
