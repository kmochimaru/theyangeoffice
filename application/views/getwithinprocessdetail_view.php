      ...
      <div class="card-body">
        <h4 class="card-title">
          ...
          <span style="float: right">
            <a href="<?php echo base_url() . 'getwithinprocess'; ?>" class="btn btn-sm btn-outline-secondary"><i class="fa fa-arrow-left"></i> กลับ</a>
          </span>
        </h4>
        <hr>
        <div class="row">
          <div class="col-md-12 text-left">
            <div class="form-group row">
              ...
              <div class="col-sm-10 m-t-0">
                <?php
                $files = $this->getwithinprocess_model->get_workinfofile($data->work_info_id_pri);
                ?>
        ...
        <?php
        if ($this->getwithinprocess_model->checkworkprocess($work_process_id_pri)->num_rows() == 1) {
          $work_process = $this->getwithinprocess_model->getworkprocess($work_process_id_pri)->row();
        ?>
          <hr>
          <div class="row">
            <div class="col-md-12 text-left">
        ...
        <?php } ?>
        <?php
        $workusers = $this->getwithinprocess_model->get_workuser($work_process_id_pri);
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-5">
                    <div class="form-group row">
                      ...
                      <span class="col-sm-7 col-form-span text-primary" style="font-size: 14px;"><?php echo $this->getwithinprocess_model->get_user($workuser->user_id)->user_fullname; ?></span>
                    </div>
                  </div>
                  <div class="col-sm-1 text-center"></div>
                  <div class="col-sm-5">
        ...
        <div class="row">
          <div class="col-md-12 text-right">
            <a href="<?php echo base_url() . 'getwithinprocess/attach/' . $work_process_id_pri; ?>" class="btn btn-info"><i class="fa fa-paperclip"></i>&nbsp;เพิ่มไฟล์เอกสาร</a>
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  ...
                  if ($files->num_rows() > 0) {
                    foreach ($files->result() as $file) { ?>
                      <tr>
                        ...
                        <td><?php echo $this->getwithinprocess_model->get_user($file->user_id)->user_fullname; ?></td>
                  ...
                  $workprocessfiles = $this->getwithinprocess_model->get_workprocessfofile($work_process_id_pri);
                    ...
                    ?>
                      <tr>
                        ...
                        if ($workprocessfile->work_process_file_send == 1) {
                          ...
                          $dep_off = $this->getwithinprocess_model->getdep_off_id($workprocessfile->dep_off_id);
                          echo '<td>' . $dep_off->dep_name . '</td><td>' . $dep_off->officer_name . '</td>';
                        }
                        ?>
                        <td><?php echo $this->getwithinprocess_model->get_user($workprocessfile->user_id)->user_fullname; ?></td>
