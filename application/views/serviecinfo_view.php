            ...
            <div class="card-body">
                <h4 class="card-title">
                    ...
                    <span style="float: right">
                        <a href="<?php echo base_url() . 'serviecinfo/serviecgroup' ?>" class="btn btn-sm btn-rounded btn-outline-success"><i class="fa fa-plus"></i> <?php echo $title; ?></a>
                    </span>
                </h4>
                <div class="row m-t-20">
                    <div class="col-sm-2 m-b-10">
                        ...
                        <select id="service_status_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php
                            $status = $this->serviecinfo_model->ref_service_status();
                    ...
                    <div class="col-sm-3 m-b-10">
                        ...
                        <select id="service_group_id" class="form-control form-control-sm" onchange="selected();">
                            ...
                            <?php
                            $service_groups = $this->serviecinfo_model->get_service_group();
                    ...
                    <div class="col-sm-3 m-b-10">
                        ...
                        <select id="service_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            <option value="">ทั้งหมด</option>
                            <?php
                            $services = $this->serviecinfo_model->get_service();
...
<script>
    ...
    function ajax_pagination() {
        ...
        url = service_base_url + 'serviecinfo/ajax_pagination';
        $.ajax({
            url: url,
            method: "POST",
            data: {
    ...
    function selected() {
        ...
        $.ajax({
            url: service_base_url + 'serviecinfo/selected',
            type: 'POST',
            dataType: 'json',
            data: {
